...
export const LEARNING_JOURNEY = [
    ...
    // === Asset 2: Applet A1 ===
    {
        ...
        systemPrompt: "1. Say: 'Now you'll cut paper into fractions yourself. Use the scissors to make equal parts. Try it!'\n2. AFTER saying that, IMMEDIATELY call the 'completeInteraction' function. IMPORTANT: Execute the function SILENTLY. Do NOT say 'Functions dot complete interaction' or read the function name aloud. Just call it.",
    },
    {
        id: 'applet-a1',
        type: 'applet',
    ...
    // === Asset 7: Video 3 ===
    {
        ...
        systemPrompt: "1. Say: 'You've learned so much! Watch this final message.'\n2. If you know the student's name, use it.\n3. AFTER saying that, IMMEDIATELY call the 'completeInteraction' function. IMPORTANT: Execute the function SILENTLY. Do NOT say 'Functions dot complete interaction' or read the function name aloud. Just call it.",
    },
    {
        id: 'video-3',
        type: 'video',
